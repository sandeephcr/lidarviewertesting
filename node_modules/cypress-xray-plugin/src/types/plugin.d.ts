...
import type { MultipartInfo, MultipartInfoCloud } from "./xray/requests/import-execution-multipart-info";
/**
...
interface PluginEventSubscriber {
     ...
     */
    (event: "upload:cypress", handler: (data: PluginEvent["upload:cypress"]) => Promise<void> | void): void;
    /**
     ...
     * @param handler - the event handler
     */
    (event: "upload:cucumber", handler: (data: PluginEvent["upload:cucumber"]) => Promise<void> | void): void;
}
/**
 * Options for configuring the general behaviour of the plugin.
 */
 ...
 * default/fallback values are used by the plugin.
 */
export type InternalPluginOptions = PluginOptions & Required<Pick<PluginOptions, "debug" | "enabled" | "logDirectory" | "normalizeScreenshotNames" | "splitUpload" | "uploadLastAttempt">>;
/**
