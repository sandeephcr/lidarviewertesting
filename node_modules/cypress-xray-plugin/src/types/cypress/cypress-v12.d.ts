...
export interface Cypress {
    _: _.LoDashStatic;
    $: JQueryStatic;
    action: (action: string, ...args: any[]) => any[] | undefined;
    arch: string;
...
export interface PluginEvents {
    ...
    (action: "before:browser:launch", fn: (browser: Browser, browserLaunchOptions: BrowserLaunchOptions) => BrowserLaunchOptions | Promise<BrowserLaunchOptions> | undefined): void;
