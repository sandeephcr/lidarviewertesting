...
it("LVH-7135 LVH-7380 Verify Recollect Notes accepts Integer, saves to server and imports correctly", () => {
  ...
  it("LVH-7382 Verify Recollect Notes accepts Negative, imports from server", () => {
    saveAndImportPoles('Recollect Notes', VALIDATION_DATA.NEGATIVE);
  });
 
  it("LVH-7384 Verify Recollect Notes accepts Scientific Notation, imports from server", () => {
    saveAndImportPoles('Recollect Notes', VALIDATION_DATA.SCIENTIFIC);
  });
 
  it("LVH-7391 Verify Recollect Notes accepts Geo Data, imports from server", () => {
    saveAndImportPoles('Recollect Notes', VALIDATION_DATA.GEO_DATA);
  });
 
  it("LVH-7144 Verify Recollect Notes accepts Boolean, saves to server", () => {
