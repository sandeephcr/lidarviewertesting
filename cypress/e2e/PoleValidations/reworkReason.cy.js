...
it("LVH-7125 LVH-7368 Verify Rework Reason accepts Integer, saves to server and imports correctly", () => {
  ...
  it("LVH-7370 Verify Rework Reason accepts Negative, imports from server", () => {
    saveAndImportPoles('Rework Reason', VALIDATION_DATA.NEGATIVE);
  });
 
  it("LVH-7372 Verify Rework Reason accepts Scientific Notation, imports from server", () => {
    saveAndImportPoles('Rework Reason', VALIDATION_DATA.SCIENTIFIC);
  });
 
  it("LVH-7379 Verify Rework Reason accepts Geo Data, imports from server", () => {
    saveAndImportPoles('Rework Reason', VALIDATION_DATA.GEO_DATA);
  });
 
  it("LVH-7134 Verify Rework Reason accepts Boolean, saves to server", () => {
