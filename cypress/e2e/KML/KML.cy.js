...
describe("KML Module", () => {
  ...
  it("LVH-3021 KML_001 - Verifying the functionality of exporting all types of measurement data as KML file to local machine ", () => {
  ...
  it("LVH-3011 KML_002 - Verifying the functionality of exporting horizontal measurement data as GeoJason file format to local machine  ", () => {
  ...
  it("LVH-2999 KML_003 - Verify the functionality of exporting vertical measurement data as a shapefile to local machine", () => {
  ...
  it("LVH-2998 KML_004 - Verify the functionality of exporting Point-to-Point measurement data as a shapefile to local machine", () => {
